...
class Joint:
    ...
    def __init__(self, number_joint, positive_angle_limit, negative_angle_limit, step_limit):
        ...
        self.motor_dir = 1  # параметр, задающий сторону полуокружности вращения
    ...
    def change_positive_angle_limit(self, positive_angle_limit) -> None:
        self.positive_angle_limit = positive_angle_limit

    def change_negative_angle_limit(self, negative_angle_limit) -> None:
        self.negative_angle_limit = negative_angle_limit
